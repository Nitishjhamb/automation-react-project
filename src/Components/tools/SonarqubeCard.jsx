...
const SonarqubeCard = ({ projectKey }) => {
  ...
  const getMetricValue = (metricKey) => {
    const measure = metrics?.component?.measures?.find(
      (m) => m.metric === metricKey
    );
    ...
    <Card className="w-full shadow-lg">
      <CardHeader className="border-b">
        <div className="flex items-center justify-between">
          ...
          <div
            className={`flex items-center gap-2 font-medium ${getQualityGateColor(
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <p className="text-2xl font-bold">
              {getMetricValue("vulnerabilities")}
            </p>
          </div>
